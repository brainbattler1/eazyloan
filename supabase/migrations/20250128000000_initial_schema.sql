...
-- This migration creates the complete database schema for the loan application system
...
-- Drop auth triggers (these should exist)
...
DROP FUNCTION IF EXISTS check_user_exists_by_email(text) CASCADE;
...
-- Utility function to execute dynamic SQL statements
...
-- Function to create user profile (with ON CONFLICT handling)
...
-- Function to create status notification
